...
| **`TextOverlayInlineEditor` / `TextOverlayFormatBar`** | On-page UITextView editing and keyboard formatting bar (Markup-style), including opacity and range formatting. |
